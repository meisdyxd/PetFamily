...
namespace PetFamily.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250806194226_Initial")]
            ...
            modelBuilder.Entity("PetFamily.Domain.VolunteerManagement.Pet", b =>
                {
                    ...
                    b.OwnsMany("PetFamily.Domain.Shared.ValueObjects.Requisit", "Requisits", b1 =>
                        {
                    ...
                    b.OwnsMany("PetFamily.Domain.VolunteerManagement.ValueObjects.Photo", "Photos", b1 =>
                        {
                            b1.Property<Guid>("PetId")
                                .HasColumnType("uuid");
